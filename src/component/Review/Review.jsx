...
const Review = () => {
  ...
  return (
    <div>
      <div className="2xl:container mx-auto bg-[#f9fafb] mt-20">
        <div className="w-[90%] md:w-[80%] mx-auto grid sm:grid-cols-1 md:grid-cols-2">
          ...
          >
            <img
              src="https://ik.imagekit.io/ajql7av7t/Thinkmetal/Logomark.png"
              className="h-[100px] pb-6 pt-4"
            />
            <p className="text-left text-black font-light font-[Inter] pb-6">
            ...
            <div className="flex space-x-3 mt-3">
              <img
                src="https://ik.imagekit.io/ajql7av7t/Thinkmetal/image.png"
                alt="Logo"
              />
              <div>
                <p className="leading-none text-left text-black font-medium font-[Inter] pb-1">
                  Gabriel Valdivia
                </p>
          ...
          >
            <img
              src="https://ik.imagekit.io/ajql7av7t/Thinkmetal/Acme%20Group.png"
              className="pb-6 pt-4"
            />
            <p className="text-left text-black font-light font-[Inter] pb-6">
            ...
            <div className="flex space-x-3 mt-3">
              <img
                src="https://ik.imagekit.io/ajql7av7t/Thinkmetal/Avatar.png"
                alt="Logo"
              />
              <div>
                <p className="leading-none text-left text-black font-medium font-[Inter] pb-1">
